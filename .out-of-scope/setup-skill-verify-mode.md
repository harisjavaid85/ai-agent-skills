# Verify/Check Mode for `setup-repo-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-repo-skills`.
