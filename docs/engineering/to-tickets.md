...
```bash
npx skills add harisjavaid85/ai-agent-skills --skill=to-tickets
```
...
[Source](https://github.com/harisjavaid85/ai-agent-skills/tree/main/skills/engineering/to-tickets)
