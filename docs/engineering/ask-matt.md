...
```bash
npx skills add harisjavaid85/ai-agent-skills --skill=ask-matt
```
...
[Source](https://github.com/harisjavaid85/ai-agent-skills/tree/main/skills/engineering/ask-matt)
