...
Its defining constraint is the mode: this is the **batched** counterpart to inline term-sharpening. It exists for the two moments a repo needs the whole glossary at once (first establishment, and a periodic drift audit) rather than for capturing terms one at a time as design work happens.

## When to reach for it

You invoke this by typing `/bootstrap-context`, and the agent won't reach for it on its own.
