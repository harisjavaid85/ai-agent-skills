...
```bash
npx skills add harisjavaid85/ai-agent-skills --skill=grilling
```
...
[Source](https://github.com/harisjavaid85/ai-agent-skills/tree/main/skills/productivity/grilling)
