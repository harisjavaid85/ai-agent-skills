...
The defining constraint is right in the name of its gate: requirements must be **settled** first. The skill refuses to gather scope itself — a shallow self-interview produces low-quality drafts — and sends you to a grilling session when the design is still fuzzy.
