...
```bash
npx skills add harisjavaid85/ai-agent-skills --skill=teach
```
...
[Source](https://github.com/harisjavaid85/ai-agent-skills/tree/main/skills/productivity/teach)
...
`teach` is a reach-for-it-anytime standalone — a long-running learning project you drive session by session, not a step in a build chain. It shares no workflow with the other productivity skills; it simply owns its workspace directory and lives there. When you're unsure which skill or flow fits, [ask-author](https://github.com/harisjavaid85/ai-agent-skills/blob/main/docs/engineering/ask-author.md) routes you.
