---
name: zoom-out
description: Tell the agent to zoom out and give broader context or a higher-level perspective. Use when you're unfamiliar with a section of code or need to understand how it fits into the bigger picture. Can save the overview to `.claude/overviews/` or promote it to `docs/overviews/` when asked explicitly.
...
- **Save** → write the overview to `.claude/overviews/` (create the directory if it does not exist).
