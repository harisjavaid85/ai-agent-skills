...
**Multiple contexts:** A `CONTEXT-MAP.md` at the repo root lists the contexts, where they live, and how they relate to each other. A root `CONTEXT.md` may sit alongside the map for repo-wide carrier vocabulary:
