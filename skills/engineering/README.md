...
- **[setup-repo-skills](./setup-repo-skills/SKILL.md)** — Configure a repo for the engineering skills: set up the repo's local `.claude` config and write the `docs/agents/` config (issue tracker, triage labels, domain-doc consumer rules) the other skills consume.
