...
- **[open-pr](./open-pr/SKILL.md)** — Push the current branch and open or update its GitHub PR in a standard format: a tagged title, a summary, and the branch's commit list, with optional PRD-slug enrichment.
