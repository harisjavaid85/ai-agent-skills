...
- **[write-a-skill](./write-a-skill/SKILL.md)** — Convert settled requirements into a well-structured skill (vocabulary, behaviour, progressive disclosure). Grill first if scope is fuzzy.
