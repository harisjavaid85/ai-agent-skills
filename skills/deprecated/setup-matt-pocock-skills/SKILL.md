...
- **single-context**: one `CONTEXT.md` at the repo root — most repos are this.
- **multi-context**: `CONTEXT-MAP.md` at the root + per-folder `CONTEXT.md` files — typically a monorepo.
