...
- **[git-guardrails-claude-code](./git-guardrails-claude-code/SKILL.md)** — Superseded by [`setup-claude-code`](../productivity/setup-claude-code/SKILL.md). Use `/setup-claude-code guardrails` instead.
