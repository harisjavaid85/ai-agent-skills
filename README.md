...
- **[open-pr](./skills/engineering/open-pr/SKILL.md)** — Push the current branch and open or update its GitHub PR in a standard format: a tagged title, a summary, and the branch's commit list, with optional PRD-slug enrichment.
...
- **[write-a-skill](./skills/productivity/write-a-skill/SKILL.md)** — Convert settled requirements into a well-structured skill (vocabulary, behaviour, progressive disclosure). Grill first if scope is fuzzy.
