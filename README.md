...
- **[write-a-skill](./skills/productivity/write-a-skill/SKILL.md)** — Turn settled requirements into a well-structured skill, separating vocabulary from behaviour. Grill first if scope is fuzzy.
